...
juicer_tools="java -jar /home/neva/juicer_tools.1.9.8_jcuda.0.8.jar"
bigWigToWig="/home/neva/bigWigtoWig"
...
do
	...
	then
	    ...
	    ./scale.a -q 0.001 chr${chr}_${res}.txt chr${chr}.out scaled.out
	    rm chr${chr}.out
	else
	    ...
	    # call scale; output is normalization vector
	    ./scale.a -q 0 chr${chr}_${res}.txt chr${chr}_${res}_summed.txt scaled.out
